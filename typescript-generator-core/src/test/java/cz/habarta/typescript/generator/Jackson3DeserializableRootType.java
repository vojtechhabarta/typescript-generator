...
public class Jackson3DeserializableRootType {
    ...
    public void testRootTypeIncludedIfNotAbstract() {
        final String output = new TypeScriptGenerator(TestUtils.settings(JsonLibrary.jackson3)).generateTypeScript(Input.from(NonAbstractRoot.class));
    ...
    public void testRootTypeNotIncludedIfAbstract() {
        final String output = new TypeScriptGenerator(TestUtils.settings(JsonLibrary.jackson3)).generateTypeScript(Input.from(AbstractRoot.class));
