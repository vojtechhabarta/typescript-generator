...
public class ReadOnlyWriteOnlyTest {
    ...
    public void test() {
        ...
        String expected6 = "\n"
                ...
                + "    password2: string;\n"
                + "}\n";
        Assertions.assertTrue(output.equals(expected1) || output.equals(expected2) || output.equals(expected3) || output.equals(expected4) || output.equals(expected5) || output.equals(expected6));
    }
