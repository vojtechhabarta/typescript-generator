...
public class GenerateMojo extends AbstractMojo {
     ...
     */
    @Parameter
    private @Nullable TypeScriptFileType outputFileType;
     ...
     */
    @Parameter
    private @Nullable String umdNamespace;
     ...
     */
    @Parameter
    private @Nullable List<ModuleDependency> moduleDependencies;
     ...
     */
    @Parameter
    private @Nullable List<String> classPatterns;

    /**
     * Classes to process specified by annotations.
     */
    @Parameter
    private @Nullable List<String> classesWithAnnotations;

    /**
     * Classes to process specified by implemented interface.
     */
    @Parameter
    private @Nullable List<String> classesImplementingInterfaces;

    /**
     * Classes to process specified by extended superclasses.
     */
    @Parameter
    private @Nullable List<String> classesExtendingClasses;
     ...
     */
    @Parameter
    private @Nullable String classesFromJaxrsApplication;
     ...
     */
    @Parameter
    private @Nullable List<String> scanningAcceptedPackages;

    /**
     * List of classes excluded from processing.
     */
    @Parameter
    private @Nullable List<String> excludeClasses;
     ...
     */
    @Parameter
    private @Nullable List<String> excludeClassPatterns;

    /**
     * If this list is not empty then only properties with any of these annotations will be included.
     */
    @Parameter
    private @Nullable List<String> includePropertyAnnotations;

    /**
     * Properties with any of these annotations will be excluded.
     */
    @Parameter
    private @Nullable List<String> excludePropertyAnnotations;
     ...
     */
    @Parameter
    private @Nullable Jackson2Configuration jackson2Configuration;
     ...
     */
    @Parameter
    private @Nullable Jackson3Configuration jackson3Configuration;
     ...
     */
    @Parameter
    private @Nullable GsonConfiguration gsonConfiguration;
     ...
     */
    @Parameter
    private @Nullable JsonbConfiguration jsonbConfiguration;
     ...
     */
    @Parameter
    private @Nullable List<String> additionalDataLibraries;
     ...
     */
    @Parameter
    private @Nullable OptionalProperties optionalProperties;
     ...
     */
    @Parameter
    private @Nullable OptionalPropertiesDeclaration optionalPropertiesDeclaration;
     ...
     */
    @Parameter
    private @Nullable NullabilityDefinition nullabilityDefinition;
     ...
     */
    @Parameter
    private @Nullable String removeTypeNamePrefix;
     ...
     */
    @Parameter
    private @Nullable String removeTypeNameSuffix;
     ...
     */
    @Parameter
    private @Nullable String addTypeNamePrefix;
     ...
     */
    @Parameter
    private @Nullable String addTypeNameSuffix;
     ...
     */
    @Parameter
    private @Nullable List<String> customTypeNaming;
     ...
     */
    @Parameter
    private @Nullable String customTypeNamingFunction;
     ...
     */
    @Parameter
    private @Nullable List<String> referencedFiles;
     ...
     */
    @Parameter
    private @Nullable List<String> importDeclarations;
     ...
     */
    @Parameter
    private @Nullable List<String> customTypeMappings;
     ...
     */
    @Parameter
    private @Nullable List<String> customTypeAliases;
     ...
     */
    @Parameter
    private @Nullable DateMapping mapDate;
     ...
     */
    @Parameter
    private @Nullable MapMapping mapMap;
     ...
     */
    @Parameter
    private @Nullable EnumMapping mapEnum;
     ...
     */
    @Parameter
    private @Nullable IdentifierCasing enumMemberCasing;
     ...
     */
    @Parameter
    private @Nullable List<String> nonConstEnumAnnotations;
     ...
     */
    @Parameter
    private @Nullable ClassMapping mapClasses;
     ...
     */
    @Parameter
    private @Nullable List<String> mapClassesAsClassesPatterns;
     ...
     */
    @Parameter
    private @Nullable List<String> disableTaggedUnionAnnotations;
     ...
     */
    @Parameter
    private @Nullable RestNamespacing restNamespacing;
     ...
     */
    @Parameter
    private @Nullable String restNamespacingAnnotation;
     ...
     */
    @Parameter
    private @Nullable String restResponseType;
     ...
     */
    @Parameter
    private @Nullable String restOptionsType;
     ...
     */
    @Parameter
    private @Nullable String customTypeProcessor;
     ...
     */
    @Parameter
    private @Nullable List<File> javadocXmlFiles;
     ...
     */
    @Parameter
    private @Nullable List<Settings.ConfiguredExtension> extensionsWithConfiguration;
     ...
     */
    @Parameter
    private @Nullable List<String> optionalAnnotations;
     ...
     */
    @Parameter
    private @Nullable List<String> requiredAnnotations;
     ...
     */
    @Parameter
    private @Nullable List<String> nullableAnnotations;
     ...
     */
    @Parameter
    private @Nullable String npmName;
     ...
     */
    @Parameter
    private @Nullable String npmVersion;
     ...
     */
    @Parameter
    private @Nullable String npmTypescriptVersion;
     ...
     */
    @Parameter
    private @Nullable String npmBuildScript;
     ...
     */
    @Parameter
    private @Nullable List<String> npmDependencies;
     ...
     */
    @Parameter
    private @Nullable List<String> npmDevDependencies;
     ...
     */
    @Parameter
    private @Nullable List<String> npmPeerDependencies;
     ...
     */
    @Parameter
    private @Nullable StringQuotes stringQuotes;
     ...
     */
    @Parameter
    private @Nullable List<String> jackson2Modules;

    /**
     * Specifies Jackson3 modules to use.
     */
    @Parameter
    private @Nullable List<String> jackson3Modules;
     ...
     */
    @Parameter
    private Logger.@Nullable Level loggingLevel;
